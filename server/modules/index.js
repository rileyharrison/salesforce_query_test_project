...
router.get("/pull", function (req, res) {
  ...
  // query += "Opportunity WHERE StageName ='Posted'  AND Donation_SubCategory__c = 'Staff' limit 20";

  var query = "SELECT Donation_SubCategory__c, SUM(Amount) FROM  Opportunity WHERE StageName = 'Posted' AND Amount != null   GROUP BY Donation_SubCategory__c ";
